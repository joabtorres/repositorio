                ...
                <article class="card-body">
                    <form class="row g-3 needs-validation" method="POST" action="<?php echo BASE_URL ?>turma/cadastrar" enctype="multipart/form-data" autocomplete="off"  name="nFormTurma">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="iTurma" name= "nTurma" placeholder="Exemplo: TADS15" value="<?php isset($cadForm['turma']) ? $cadForm['turma'] : '' ?>" required>
                            <div class="invalid-feedback">
                                Informe a turma
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="iAno" name="nAno" placeholder="Exemplo: 2015" value="<?php isset($cadForm['ano']) ? $cadForm['ano'] : '' ?>"required>
                            <div class="invalid-feedback">
