        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb p-3 bg-light">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo BASE_URL ?>turma/consultar" class="text-decoration-none"> <i class="fa fa-search"></i> Consultar Turma</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-edit"></i> Turma </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-12 mt-1">
            <section class="card bg-light">
                <header class="card-header bg-success text-white">
                    <h5 class="card-title m-2"><i class="fa fa-edit"></i>  Turma</h5>
                </header>
                <article class="card-body">
                    <form class="row g-3 needs-validation" method="POST" action="<?php echo BASE_URL ?>turma/editar/<?php echo $cadForm['cod']?>" enctype="multipart/form-data" autocomplete="off"  name="nFormTurma">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="iTurma" name= "nTurma" placeholder="Exemplo: TADS15" value="<?php echo !empty($cadForm['turma']) ? $cadForm['turma'] : '' ?>" required>
                            <div class="invalid-feedback">
                                Informe a turma
                            </div>
                        </div>
