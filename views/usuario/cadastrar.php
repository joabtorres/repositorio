        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb p-3 bg-light">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-add"></i> Usuário </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-12 mt-1">
            <section class="card bg-light">
                <header class="card-header bg-success text-white">
                    <h5 class="card-title m-2"><i class="fa fa-plus-square"></i>  Usuário</h5>
                </header>
                <article class="card-body">
                    <form class="row g-3 needs-validation" method="POST" action="<?php echo BASE_URL ?>usuario/cadastrar" enctype="multipart/form-data" autocomplete="off"  name="nFormUsuario">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="iNome" name= "nNome" placeholder="Exemplo: João Garcia" value="<?php isset($cadForm['nome']) ? $cadForm['nome'] : '' ?>" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="email" class="form-control" id="iEmail" name= "nEmail" placeholder="Exemplo: joao.garcia@gmail.com" value="<?php isset($cadForm['email']) ? $cadForm['email'] : '' ?>" required>
                            <div class="invalid-feedback">
                                Informe o e-mail
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="password" class="form-control" id="iSenha" name="nSenha" placeholder="Exemplo: *********" value="<?php isset($cadForm['senha']) ? $cadForm['senha'] : '' ?>"required>
                            <div class="invalid-feedback">
                                Informe a senha
                            </div>
                        </div>
